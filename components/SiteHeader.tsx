...
export default function SiteHeader(){
  return <header className="site-header"><div className="container nav">
    ...
    <nav className="nav-links" aria-label="Primary navigation">
      <Link href="/services">Services</Link><Link href="/framework">Framework</Link><Link href="/selected-work">Our Work</Link><Link href="/resources">Resources</Link><Link href="/insights">Insights</Link><Link href="/about">About</Link>
    </nav>
